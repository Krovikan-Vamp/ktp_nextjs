...
const ReponsiveNavContent = () => {
    ...
    return (<>
                ...
                <ul className="relative m-0 list-none px-[0.2rem] " data-te-sidenav-menu-ref>
                    ...
                    <li className="relative">
                        <a
                            ...
                            data-te-sidenav-link-ref>
                            <span className={styles.span_styles}>
                                <svg width="700pt" class="path" height="700pt" version="1.1" viewBox="0 0 700 700" xmlns="http://www.w3.org/2000/svg" >
                                    <g>
        ...
        <div id="slim-content" className="flex !pl-[77px] h-24 absolute bottom-4 space-x-2 right-5 ">
            {/* <!-- Toggler --> */}
            <button
