...
const SplashScreen = ({ finishLoading }) => {
    ...
    return (<div id="splashmove" className="flex items-center justify-center w-full h-screen overflow-hidden bg-black" isMounted={isMounted}>
        {/* <Image id="logo" src={logoIcon} width={200} height={200} alt="Bullshit" /> */}
        <svg id="logo" fill-opacity={0} fill="orange" className="w-1/2 m-auto translate-y-14 stroked_path stroke-orange-400" width="700pt" height="700pt" version="1.1" viewBox="0 0 700 700" xmlns="http://www.w3.org/2000/svg">
